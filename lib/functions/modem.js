...
module.exports = function (SerialPort) {
  ...
  modem.setOwnNumber = (number, callback, name = 'OwnNumber', timeout = 15000) => {
    if (typeof callback !== 'function') {
      return new Promise((resolve, reject) => {
  ...
  modem.getSimInbox = (callback, timeout = 15000) => {
    ...
    const item = modem.executeCommand((modem.modemMode === 0 ? `AT+CMGF=0;+CMGL=4` : `AT+CMGF=1;+CMGL="ALL"`), (result, error) => {
      callback(result, error)
    }, false, timeout)
